...
public abstract class AbstractColorArgumentHandler<T> extends GalaxyCommandArgumentHandler<T> {
    ...
    public AbstractColorArgumentHandler(GalaxyPlugin galaxyPlugin, Class<T> clazz) {
        super(galaxyPlugin, clazz);
    }

    protected abstract T rgbToColor(int r, int g, int b);

    @Override
    protected final T handleInternal(GalaxyCommandArgumentInfo argumentInfo, ArgumentParser argumentParser) {
    ...
    @Override
    protected final List<String> suggestInternal(GalaxyCommandArgumentInfo argumentInfo, ArgumentParser argumentParser) {
        String input = argumentParser.next();
